...
public abstract class MixinVaultArmorItem
{
    ...
    public void customRoll$tickRoll(ItemStack stack, Player player)
    {
        ...
        Set<ResourceLocation> gearModelIDs =
            ModConfigs.GEAR_MODEL_ROLL_RARITIES.getPossibleRolls(((VaultArmorItem) (Object) this),
                rarity,
