...
public abstract class MixinVaultShieldItem
{
    ...
    public void customRoll$tickRoll(ItemStack stack, Player player)
    {
        ...
        Set<ResourceLocation> gearModelIDs =
            ModConfigs.GEAR_MODEL_ROLL_RARITIES.getPossibleRolls(((VaultShieldItem) (Object) this),
                rarity,
