...
/**
 * This mixin is used to add custom roll to VaultAxeItem.
 */
@Mixin(value = VaultAxeItem.class, remap = false)
...
public abstract class MixinVaultAxeItem
{
    ...
    public void customRoll$tickRoll(ItemStack stack, Player player)
    {
        ...
        Set<ResourceLocation> gearModelIDs =
            ModConfigs.GEAR_MODEL_ROLL_RARITIES.getPossibleRolls(((VaultAxeItem) (Object) this),
                rarity,
